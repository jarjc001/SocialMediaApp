...
CREATE TABLE comments(
    ...
    username VARCHAR(255) NOT NULL,  -- fk username of the commenter
...
CREATE TABLE likes(
	postID BIGINT NOT NULL,			-- fk
	username VARCHAR(255) NOT NULL,  -- fk username of the liker
...
CREATE TABLE subscriptions(
    ...
    subUsers VARCHAR(255) NOT NULL,	-- other users that this user is subscribed to 
